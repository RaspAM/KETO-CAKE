...
async def show_info(event: types.Message | types.CallbackQuery):
    text = (
        ...
        "• <b>Комфорт ЖКТ и здоровье зубов::</b>Не создаёт условий для роста патогенных бактерий в ротовой полости, желудке и кишечнике, 
        ...
        "и бутирата — здоровье кишечника и защита слизистой. "
