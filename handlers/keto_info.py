...
async def show_info(event: types.Message | types.CallbackQuery):
    ...
    "<b>1. Польза вашему здоровью</b>\n"
    "• <b>Комфорт ЖКТ и здоровье зубов:</b> Не создают условий для роста вредных бактерий в ротовой полости, желудке и кишечнике, "
    ...
    "диабета, а также сердечно-сосудистых и системных заболеваний."
)
