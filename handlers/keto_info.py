...
async def show_info(event: types.Message | types.CallbackQuery):
    text = (
        ...
        "• <b>Комфорт ЖКТ и здоровье зубов::</b> создаёт условий для роста патогенных бактерий в ротовой полости, желудке и кишечнике, помогая снизить риск кариеса, изжоги и тяжести после еды..\n"
